    ...
    <main className="bg-zinc-950 min-h-screen text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-40 pb-24 grid md:grid-cols-2 gap-16">
        <div>
          ...
          <div className="bg-red-600 p-8 border-4 border-white shadow-[12px_12px_0px_0px_rgba(255,255,255,1)] hover:shadow-none hover:translate-x-[12px] hover:translate-y-[12px] transition-all duration-300">
            ...
            <p className="font-bold text-lg text-white mt-4 pt-4 border-t-2 border-white/30">📧 info@dgsportindia.com</p>
          </div>
        </div>
        ...
        <form className="bg-white p-8 border-4 border-black shadow-[16px_16px_0px_0px_rgba(220,38,38,1)] text-black flex flex-col gap-6">
          ...
          <input type="text" placeholder="ACADEMY NAME" className="border-4 border-black p-4 font-bold uppercase focus:outline-none focus:border-red-600 bg-zinc-50 transition-colors" />
          <input type="email" placeholder="EMAIL ADDRESS" className="border-4 border-black p-4 font-bold uppercase focus:outline-none focus:border-red-600 bg-zinc-50 transition-colors" />
          <textarea rows={4} placeholder="WHAT GEAR DO YOU NEED?" className="border-4 border-black p-4 font-bold uppercase focus:outline-none focus:border-red-600 bg-zinc-50 transition-colors"></textarea>
