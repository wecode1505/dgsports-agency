...
export default function Home() {
  ...
  // Trigger the loading screen for 2.5 seconds
  useEffect(() => {
  ...
  return (
    <>
          ...
          >
            <div className="flex flex-col items-center">
              <motion.h1
                ...
                className="text-2xl md:text-3xl font-black tracking-[0.2em] uppercase mb-6"
              >
                DG SPORT<span className="text-red-600 font-light">DEMO</span>
              </motion.h1>
              
              {/* The Loading Bar */}
              <div className="w-64 md:w-80 h-[2px] bg-zinc-900 overflow-hidden relative">
                <motion.div
                  initial={{ width: "0%" }}
                  animate={{ width: "100%" }}
              ...
              <motion.p
                ...
                className="text-[9px] text-zinc-600 font-bold uppercase tracking-[0.3em] mt-6 animate-pulse"
              >
                Initializing Production Ecosystem
              </motion.p>
            </div>
          </motion.div>
        )}
      ...
      {/* =========================================
          ...
          ========================================= */}
      <main className={`relative bg-[#09090b] text-white min-h-screen overflow-x-hidden selection:bg-red-500/30 transition-opacity duration-1000 ${isLoading ? 'opacity-0 h-screen overflow-hidden' : 'opacity-100'}`}>
        <Navbar />
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-32 pb-20 px-6 z-10 w-full">
          <div className="max-w-7xl mx-auto w-full grid xl:grid-cols-2 gap-16 xl:gap-8 items-center">
            ...
            <motion.div 
              // Notice we added a delay here so the text animates IN only AFTER the loading screen lifts
